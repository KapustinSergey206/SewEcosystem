...
-- SET transaction_timeout = 0; -- Закомментировано для совместимости с PostgreSQL 16/17
...
14	Главный администратор	admin@partner.local	+70000000000	$2a$10$Z8tX0Ml7O8YBP.qv81y1Q.LDsPTwRXab/M03Yz4wXM2KoJmRgQsVu	admin	2026-06-07 13:38:54.46992+03
...
SELECT pg_catalog.setval('public.order_status_history_id_seq', 29, true);
